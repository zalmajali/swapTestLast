...
@Component({
  selector: 'app-productsaddsuccess',
  templateUrl: './productsaddsuccess.page.html',
  styleUrls: ['./productsaddsuccess.page.scss'],
})
export class ProductsaddsuccessPage implements OnInit {
  public fullName:any;
  public userId:any;
  ...
  public floatTow:any;
  public back:any;
  public addProductSucsess:any;
  public approveProduct:any;
  public approveProductEdit:any;
  //menue
  public menuOne:any;
  public menuTow:any;
  ...
  initialiseTranslation(){
    ...
    this.translate.get('addProductSucsess').subscribe((res: string) => {
      this.addProductSucsess = res;
    });
    this.translate.get('approveProduct').subscribe((res: string) => {
      this.approveProduct = res;
    });
    this.translate.get('approveProductEdit').subscribe((res: string) => {
      this.approveProductEdit = res;
    });
    ////menue
