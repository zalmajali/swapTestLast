...
export class DeleteaccountPage implements OnInit {
  ...
  public swap: any;
  public floatD:any;
  public deleteAccountTitle:any;
  public deleteAccountVal:any;
  public deleteAccountMsg:any;
  public deleteAccountMsgNote:any;
  public deleteAccountMsgOne:any;
  public deleteAccountMsgTow:any;
  public deleteAccountMsgThree:any;
  //menue
  public menuOne:any;
  public menuTow:any;
  ...
  initialiseTranslation(){
    ...
    this.translate.get('deleteAccountTitle').subscribe((res: string) => {
      this.deleteAccountTitle = res;
    });
    this.translate.get('deleteAccountMsg').subscribe((res: string) => {
      this.deleteAccountMsg = res;
    });
    this.translate.get('deleteAccountMsgNote').subscribe((res: string) => {
      this.deleteAccountMsgNote = res;
    });
    this.translate.get('deleteAccountMsgOne').subscribe((res: string) => {
      this.deleteAccountMsgOne = res;
    });
    this.translate.get('deleteAccountMsgTow').subscribe((res: string) => {
      this.deleteAccountMsgTow = res;
    });
    this.translate.get('deleteAccountMsgThree').subscribe((res: string) => {
      this.deleteAccountMsgThree = res;
    });
    this.translate.get('cancel').subscribe((res: string) => {
      this.deleteAccountVal = res;
    });
    ////menue
  ...
  deleteAccount(){
    this.usersService.deleteAccount(this.userId).then(async data=>{
      ...
      if(this.operationResult==1){
        this.message = this.deleteAccountMsgOne;
        this.displayResult(this.message);
        this.navCtrl.navigateRoot('login');
      }else if(this.operationResult==2){
        this.message = this.deleteAccountMsgTow;
        this.displayResult(this.message);
      }else if(this.operationResult==3){
        this.message = this.deleteAccountMsgThree;
        this.displayResult(this.message);
      }
    }).catch(e=>{
      this.message = this.deleteAccountMsgThree;
