...
@Component({
  selector: 'app-complaintssuccessfully',
  templateUrl: './complaintssuccessfully.page.html',
  styleUrls: ['./complaintssuccessfully.page.scss'],
})
export class ComplaintssuccessfullyPage implements OnInit {
  public fullName:any;
  public userId:any;
  ...
  public floatD:any;
  public floatTow:any;
  public complainDetailsSucsessOne:any;
  public complainDetailsSucsessTow:any;
  //menue
  public menuOne:any;
  public menuTow:any;
  ...
  initialiseTranslation(){
    ...
    this.translate.get('complainDetailsSucsessOne').subscribe((res: string) => {
      this.complainDetailsSucsessOne = res;
    });
    this.translate.get('complainDetailsSucsessTow').subscribe((res: string) => {
      this.complainDetailsSucsessTow = res;
    });
    ////menue
