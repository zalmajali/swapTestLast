...
export class AccountPage implements OnInit {
  ...
  public accountNamePlaceHolder:any;
  public accountNameError:any;
  public accountCommercialNamePlaceHolder:any;
  public accountCommercialNameError:any;
  ...
  public accountCatError:any;
  public accountSubCatPlaceHolder:any;
  public accountSubCatError:any;
  ...
  public accountDetalePlaceHolder:any;
  ...
  public no:any;
  public yas:any;
  public accountPersonalImage:any;
  public accountServImage:any;
  public accountEdit:any;
  public accountMsgOne:any;
  public accountMsgTow:any;
  public accountMsgThree:any;
  public accountMsgFor:any;
  public accountMsgFive:any;
  ...
  initialiseTranslation(){
    ...
    this.translate.get('accountNamePlaceHolder').subscribe((res: string) => {
      this.accountNamePlaceHolder = res;
    });
    this.translate.get('accountNameError').subscribe((res: string) => {
      this.accountNameError = res;
    });
    this.translate.get('accountCommercialNamePlaceHolder').subscribe((res: string) => {
      this.accountCommercialNamePlaceHolder = res;
    });
    this.translate.get('accountCommercialNameError').subscribe((res: string) => {
      this.accountCommercialNameError = res;
    });
    ...
    this.translate.get('accountPersonalImage').subscribe((res: string) => {
      this.accountPersonalImage = res;
    });
    this.translate.get('accountServImage').subscribe((res: string) => {
      this.accountServImage = res;
    });

    this.translate.get('accountCatPlaceHolder').subscribe((res: string) => {
      this.accountCatPlaceHolder = res;
    });
    this.translate.get('accountCatError').subscribe((res: string) => {
      this.accountCatError = res;
    });
    this.translate.get('accountSubCatPlaceHolder').subscribe((res: string) => {
      this.accountSubCatPlaceHolder = res;
    });
    this.translate.get('accountSubCatError').subscribe((res: string) => {
      this.accountSubCatError = res;
    });
    ...
    this.translate.get('accountDetalePlaceHolder').subscribe((res: string) => {
      this.accountDetalePlaceHolder = res;
    });
    this.translate.get('accountDetaleError').subscribe((res: string) => {
      this.accountDetaleError = res;
    });
    this.translate.get('accountEdit').subscribe((res: string) => {
      this.accountEdit = res;
    });
    this.translate.get('accountSelect').subscribe((res: string) => {
      this.accountSelect = res;
    });
    this.translate.get('accountMsgOne').subscribe((res: string) => {
      this.accountMsgOne = res;
    });
    this.translate.get('accountMsgTow').subscribe((res: string) => {
      this.accountMsgTow = res;
    });
    this.translate.get('accountMsgThree').subscribe((res: string) => {
      this.accountMsgThree = res;
    });
    this.translate.get('accountMsgFor').subscribe((res: string) => {
      this.accountMsgFor = res;
    });
    this.translate.get('accountMsgFive').subscribe((res: string) => {
      this.accountMsgFive = res;
    });
  }
  async openPicker() {
  ...
  async ngOnInit(loder:any=0) {
    ...
    await this.usersService.information(this.userId).then(async data=>{
      ...
      this.typeUser = this.returnData.Data.type;
        if(this.typeUser == 1 || this.typeUser == 2){
          ...
          this.userImage = this.returnData.Data.accountImage;
          if(this.userImage == null || this.userImage == 0 || this.userImage == undefined)
            this.userImage = "../../assets/imgs/def.png";
        }
        await this.storage.set('image',this.userImage);
      this.sex = this.returnData.Data.sex;
      if(this.sex == 1){
        this.typeWork=1;
      ...
      this.selectStatusUser = this.returnData.Data.statusUser;
      this.employeeCount = this.returnData.Data.employeeCount;
      this.typeWorkVal = this.returnData.Data.typeWorkVal;
      this.birthDate = this.returnData.Data.birthDate;
  ...
  async updateAccount(){
    ...
    if(this.typeUser == 1){
      if(this.cityId == 0 && this.regionId == 0 && (this.userName == undefined || this.userName == "" || this.userName == null) && this.selectStatusUser == 0 && (this.birthDate == undefined || this.birthDate == "" || this.birthDate == null) && (this.serviceDetails == undefined || this.serviceDetails == "" || this.serviceDetails == null)){
      ...
      if(this.selectStatusUser == undefined || this.selectStatusUser == "" || this.selectStatusUser == null){
      ...
      if(this.cityId != 0 && this.regionId != 0 && this.selectStatusUser != 0 && this.userName != undefined && this.birthDate != undefined && this.serviceDetails != undefined){
        ...
        await this.usersService.updateDataOne(this.userId,this.cityId,this.regionId,this.userName,this.selectStatusUser,this.birthDate,this.serviceDetailsNew,this.sex).then(async data=>{
          ...
          if(this.operationResult==1){
            ...
            this.message = this.accountMsgThree;
            this.displayResult(this.message);
            await this.usersService.information(this.userId).then(async data=>{
              this.returnData = data;
              this.operationResult = this.returnData.Error.ErrorCode;
            ...
            this.message = this.accountMsgFor;
            this.displayResult(this.message);
          }else if(this.operationResult==3){
            this.message = this.accountMsgFive;
            this.displayResult(this.message);
          }
        }).catch(e=>{
          this.message = this.accountMsgFive;
      ...
      if(this.catIdUser == 0 && this.subCatIdUser == 0 && this.cityId == 0 && this.regionId == 0 && (this.userName == undefined || this.userName == "" || this.userName == null) && (this.userName == undefined || this.userName == "" || this.userName == null) && (this.serviceDetails == undefined || this.serviceDetails == "")){
